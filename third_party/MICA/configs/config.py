...
cfg.device = 'cuda'
cfg.device_id = '0'
cfg.pretrained_model_path = os.path.join(cfg.mica_dir, '../../assets/MICA', 'mica.tar')
cfg.output_dir = ''
...
cfg.model.topology_path = os.path.join(cfg.mica_dir, '../../assets/FLAME2020', 'head_template.obj')
cfg.model.flame_model_path = os.path.join(cfg.mica_dir, '../../assets/FLAME2020', 'generic_model.pkl')
cfg.model.flame_lmk_embedding_path = os.path.join(cfg.mica_dir, '../../assets/FLAME2020', 'landmark_embedding.npy')
