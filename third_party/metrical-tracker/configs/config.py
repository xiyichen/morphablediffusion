...
cfg.flame_geom_path = '../../assets/FLAME2020/generic_model.pkl'
cfg.flame_template_path = '../../assets/uv_template.obj'
cfg.flame_lmk_path = '../../assets/landmark_embedding.npy'
cfg.tex_space_path = '../../assets/FLAME2020/FLAME_texture.npz'
...
cfg.input_shape_path = ''
cfg.target_exp_shape_path = ''
