...
class Masking(nn.Module):
    def __init__(self):
        ...
        with open(f'{dir}/assets/FLAME2020/FLAME_masks.pkl', 'rb') as f:
            ss = pickle.load(f, encoding='latin1')
            self.masks = Struct(**ss)

        with open(f'{dir}/assets/FLAME2020/generic_model.pkl', 'rb') as f:
            ss = pickle.load(f, encoding='latin1')
            flame_model = Struct(**ss)

        self.color_mesh = trimesh.load(f'{dir}/assets/head_template_color.obj', process=False)
